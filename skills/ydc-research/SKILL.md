...
Invoke the **ydc-ctd-warmintro skill as a Sonnet subagent**, passing the target company domain. The skill handles all API calls, filtering, ranking, and ghost email drafting per its own SKILL.md.

Embed the full ydc-ctd-warmintro output verbatim into Section 9 of the research brief, including ghost emails. Do not summarize or truncate it.

**Graceful failure:** If CTD returns no data or errors, note it clearly in Section 9 and continue. CTD failure does not block the pipeline.
...
Save to: `/Users/andrew/Downloads/Claud Code folder /YDCpipeline/{company}_facts.md`
...
Save to: `/Users/andrew/Downloads/Claud Code folder /YDCpipeline/{company}_usecases.md`
...
Save to: `/Users/andrew/Downloads/Claud Code folder /YDCpipeline/{company}_hooks.md`
