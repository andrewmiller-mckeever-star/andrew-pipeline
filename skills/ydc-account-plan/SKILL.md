...
- `/Users/andrew/Downloads/Claud_Code_folder/YDCpipeline/{company}_facts.md`
- `/Users/andrew/Downloads/Claud_Code_folder/YDCpipeline/{company}_usecases.md`
- `/Users/andrew/Downloads/Claud_Code_folder/YDCpipeline/{company}_hooks.md` (for CTD warm intro data, SF flags for Section 8)

Write structured JSON to:
`/Users/andrew/Downloads/Claud_Code_folder/YDCpipeline/{company}_plan_data.json`
...
```bash
NODE_PATH=$(npm root -g) node "/Users/andrew/Downloads/Claud_Code_folder/YDCpipeline/generate-account-plan.js" "/Users/andrew/Downloads/Claud_Code_folder/YDCpipeline/{company}_plan_data.json"
```
...
| (prior) | Added Section 8 Outreach Strategy Appendix | Required to carry sequence + contact assignments through to Apollo build |
| (prior) | Added CTD Warm Intro Integration to Section 8 | Connect The Dots paths needed to flow into account plan contact table |
| (prior) | Switched from docx skill to static generate-account-plan.js | Formatting consistency; docx skill produced inconsistent styles |
