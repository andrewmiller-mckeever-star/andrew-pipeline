---
name: meeting-brief-monday-watchdog-8am
description: Monday 8am watchdog — checks if Sunday's meeting brief ran for today; if not, runs it for today's meetings
---
