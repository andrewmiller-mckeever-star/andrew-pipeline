---
name: meeting-brief-monday-watchdog-930am
description: Monday 9:30am watchdog — final check: if Sunday's meeting brief still hasn't run, executes it for today's meetings
---
